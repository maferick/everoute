...
final class SystemRepository
{
    ...
    {
        return "id, name, security, security_raw, security_nav, region_id, constellation_id, is_wormhole, is_normal_universe, has_npc_station, npc_station_count, system_size_au, x, y, z";
    }
}
