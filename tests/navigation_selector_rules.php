...
if (($resultDominance['reason'] ?? '') !== 'jump_dominates_hybrid_time_threshold') {
...
$resultPenalty = $select->invoke($engine, $gatePenalty, $jumpPenalty, $hybridPenalty, ['safety_vs_speed' => 20]);
